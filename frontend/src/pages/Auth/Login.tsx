...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gray-50">
      <div className="max-w-6xl w-full rounded-2xl shadow-2xl overflow-hidden flex" style={{ backgroundColor: '#F5F1D8' }}>
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12 overflow-y-auto max-h-screen">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600">Adarsh Gram Assessment System</p>
          </div>

          {/* Default Credentials Info */}
          <div className="mb-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
            <h3 className="text-xs font-semibold text-blue-900 mb-1.5 flex items-center gap-2">
              <span>🔑</span>
            ...
            <div className="text-xs text-blue-700 space-y-0.5">
              ...
              <p className="text-blue-600 mt-1">Or create a new account below!</p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 text-sm bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all"
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 text-gray-500" style={{ backgroundColor: '#F5F1D8' }}>Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
                <AiOutlineLoading3Quarters className="animate-spin" size={18} />

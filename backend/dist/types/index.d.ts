...
export type UserRole = 'system_admin' | 'district_admin' | 'block_officer' | 'village_reporter' | 'assessor' | 'viewer';
...
export type FocusArea = 'education' | 'healthcare' | 'sanitation' | 'connectivity' | 'drinking_water' | 'electricity' | 'skill_development' | 'livelihood';
